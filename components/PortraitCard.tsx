      ...
      <div className="editorial-photo rounded-[1.35rem] p-2.5">
        ...
        <div className="grid grid-cols-[1fr_auto] items-end gap-4 px-2 pt-4">
          <div>
            ...
            <p className="coord mt-2 text-foreground/44">AI researcher / data scientist</p>
          </div>
          <div className="text-right font-mono-label text-[0.65rem] uppercase leading-5 tracking-[0.18em] text-foreground/36">
            Karaj
            <br />
            Iran
          </div>
